                    ...
                    <div className="vision-mission-container">
                        ...
                        <div className="vision-mission-grid">
                            ...
                            <div className="mission-section">
                                ...
                                <p className="text-content text-right">
                                 إعداد وتأهيل أجيال من الكوادر المهنية المتميزة لتلبية متطلبات الشركة وسوق العمل من خلال بيئة تدريبية مثالية طبقاً لمعايير الجودة.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="strategy-items">
                                ...
                                <div className="strategy-item">
                                    ...
                                    <p className="strategy-text text-right">
                                        اعداد اجيال من الكوادر المؤهلين في بيئة مبتكرة و داعمة بتمتعون بالتميز التقني و المهارات القيادية والمهارات العملية 
                                    </p>
                                </div>
                                ...
                                <div className="strategy-item">
                                    ...
                                    <p className="strategy-text text-right">
                                         الارتقاء بالدور القيادي للمعهد في مجال التعليم الفني و التطوير للمساهمة في تنمية اقتصاد المعرفة من خلال اقامة شراكات مجتمعية فاعلة
                                    </p>
                                </div>
                                ...
                                <div className="strategy-item">
                                    ...
                                    <p className="strategy-text text-right">
                                         تعزيز دور المعهد من خلال تقديم برامج و خدمات و دراسات معتمدة محليآ و عالميآ لتحقق تطلعات العملاء و تستجيب لمتغيرات سوق العمل
                                    </p>
                                </div>
                                ...
                                <div className="strategy-item">
                                    ...
                                    <p className="strategy-text text-right">
                                        ضمان تقديم كافة الخدمات وفق معايير الجودة و الكفاءة العالمية وترسيخ ثقافة الابتكار في بيئة العمل المؤسسي
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="top-boxes">
                        ...
                        <div className="goal-box">
                            ...
                            <p className="goal-text">
                                العمل في إطار من المعايير القياسية العالمية للمتطلبات الاحترافية للمهن الهندسية والمهن الحرفية  
                            </p>
                        </div>
                        ...
                        <div className="goal-box">
                            ...
                            <p className="goal-text">
                                 التجاوب مع متطلبات الواقع وتعزيز أساليب التعلم بطرق مبتكرة وأكثر كفاءة  
                            </p>
                        </div>
                    </div>
