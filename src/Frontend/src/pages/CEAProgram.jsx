...
const CEAProgram = () => {
    ...
    return (
        <Box
            sx={{ minHeight: '100vh', bgcolor: '#ffffff', fontFamily: '"Droid Arabic Kufi", serif' }}
            dir="rtl"
            lang="ar"
        >
            {/* Breadcrumb */}
            ...
            <Container
                maxWidth="lg"
                sx={{ py: { xs: 6, md: 8 }, px: { xs: 2, sm: 3, md: 4 }, mt: `${NAV_HEIGHT + 60}px` }}
            >
                {/* Header */}
                <Box sx={{ textAlign: 'left', mb: { xs: 4, md: 6 } }}>
                    ...
                    <Typography
                        ...
                        sx={{
                            fontFamily: '"Droid Arabic Kufi", serif',
                            lineHeight: 1.9, mb: 3, color: '#000000',
                ...
                <Box sx={{ mb: { xs: 5, md: 6 }, maxWidth: "900px", mx: "auto" }}>
                    {objectives.map((objective, index) => (
                        <Box
                            key={index}
                            sx={{
                                display: 'flex', alignItems: 'flex-start', mb: 2.5,
                                textAlign: 'left', bgcolor: '#ffffff',
                                p: { xs: 2, md: 2.5 }, borderRadius: '12px',
                        ...
                        >
                            ...
                            <Typography
                                ...
                                sx={{
                                    fontFamily: '"Droid Arabic Kufi", serif',
                                    flex: 1, color: '#000000', lineHeight: 1.9,
                                    fontSize: { xs: "0.95rem", md: "1.05rem" }
                                }}
                            >
                                {objective}
                ...
                <Box sx={{ mb: { xs: 6, md: 8 } }}>
                    <Typography
                        ...
                        sx={{
                            fontFamily: '"Droid Arabic Kufi", serif',
                            fontWeight: 'bold', mb: 4, textAlign: 'center',
                            color: '#0865a8', fontSize: { xs: "1.5rem", md: "2rem" }
                        }}
                    >
                    ...
                    {stages.map((stage, index) => (
                        ...
                        >
                            <AccordionSummary
                                ...
                                sx={{ bgcolor: 'white', borderRadius: '12px', '&:hover': { bgcolor: '#f8f9fa' } }}
                            >
                                <Typography
                                    variant="h6"
                                    sx={{
                                        fontFamily: '"Droid Arabic Kufi", serif',
                                        fontWeight: 'bold', color: '#0865a8',
                            ...
                            <AccordionDetails sx={{ bgcolor: 'white', p: { xs: 2, md: 3 } }}>
                                <Typography
                                    sx={{
                                        ...
                                        color: '#000000', fontSize: { xs: "0.95rem", md: "1.05rem" }
                                    }}
                                >
                                    {stage.content}
                                </Typography>
                ...
                <Box sx={{ mb: { xs: 6, md: 8 } }}>
                    ...
                    <Box sx={{ position: 'relative', overflow: 'hidden', px: { xs: 0, md: 6 } }}>
                        ...
                        <IconButton
                            ...
                            sx={{
                                position: 'absolute', right: { xs: -10, md: 0 },
                                top: '50%', transform: 'translateY(-50%)',
                                bgcolor: 'rgba(255,255,255,0.95)', color: '#0865a8',
                                boxShadow: '0 4px 12px rgba(0,0,0,0.15)',
                                '&:hover': { bgcolor: '#f57c00', color: 'white' },
                                '&.Mui-disabled': { bgcolor: 'rgba(200,200,200,0.5)', color: '#999' },
                                zIndex: 2,
                            }}
                        >
                        ...
                        <IconButton
                            ...
                            sx={{
                                position: 'absolute', left: { xs: -10, md: 0 },
                                top: '50%', transform: 'translateY(-50%)',
                                bgcolor: 'rgba(255,255,255,0.95)', color: '#0865a8',
                                boxShadow: '0 4px 12px rgba(0,0,0,0.15)',
                                '&:hover': { bgcolor: '#f57c00', color: 'white' },
                            ...
                            {Array.from({ length: Math.ceil(galleryImages.length / 4) }).map((_, index) => (
                                <Box
                                    ...
                                    sx={{
                                        ...
                                        '&:hover': { bgcolor: currentGallerySlide === index ? '#f57c00' : '#9ca3af' }
                                    }}
                                />
                            ))}
                        </Box>
            ...
            >
                ...
                >
                    ...
                    {/* Image — no description overlay */}
                    <Box
                        component="img"
                        src={galleryImages[selectedImageIndex].src}
                        alt=""
                        sx={{ maxWidth: '90%', maxHeight: '85vh', objectFit: 'contain' }}
                    />
                    ...
                    >
                        <Typography sx={{ fontFamily: '"Droid Arabic Kufi", serif', fontSize: '0.9rem' }}>
