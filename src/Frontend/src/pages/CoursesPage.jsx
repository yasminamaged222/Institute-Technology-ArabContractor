      ...
      <div className="container mx-auto px-4 pt-0 mt-0"> 
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 py-8">
          {courses.map((course) => (
            <div
              key={course.id}
              className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col border-t-4 border-[#f57c00]"
            >
              <div className="flex justify-center pt-6">
                <div className="w-16 h-16 bg-[#f57c00] rounded-full flex items-center justify-center shadow-lg">
              ...
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="text-lg font-bold text-[#0865a8] mb-4 text-center leading-relaxed">
                  {course.title}
                </h3>

                <div className="space-y-3 mb-4">
                  <div className="flex items-start gap-2 text-sm text-gray-700">
                    <svg className="w-5 h-5 text-[#f57c00] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-700">
                    <svg className="w-5 h-5 text-[#f57c00] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button className="w-full bg-[#f57c00] text-white py-3 px-6 rounded-lg font-bold transition-all duration-300">
                  المزيد من التفاصيل
                </button>
              </div>
            </div>
